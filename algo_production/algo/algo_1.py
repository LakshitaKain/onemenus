...
def perform_ocr_with_craft_1(image: np.ndarray, resize_factor=1.0, dpi=300, use_gpu=True, json_output_path="output_dishes.json"):
    ...
    # Ensure boxes is not None or empty
